...
int main(int argc, char **argv) {
  ...
  WbDeviceTag sensor = wb_robot_get_device("DISTANCE");
  ...
  //    double sensor_val = wb_distance_sensor_get_value(sensor);
      ...
      switch (key) {
        case WB_KEYBOARD_UP:
          if (sensor_val  > 200){
            ...
            printf("Enabling Obstracle avoidance");
          }
          else{           
